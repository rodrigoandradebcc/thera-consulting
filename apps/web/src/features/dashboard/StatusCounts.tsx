    ...
    <div className="mb-8 grid gap-3 sm:grid-cols-3 lg:grid-cols-5">
      {SALES_ORDER_STATUSES.map((status) => (
        <Link
          ...
          className="rounded-xl border border-border bg-card p-4 shadow-panel transition-colors hover:bg-muted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
        >
